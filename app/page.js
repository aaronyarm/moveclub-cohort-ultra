              ...
              {enhancedAnalytics && (
                <>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    ...
                    <MetricCard 
                      label="Gross Revenue"
                      value={`$${parseFloat(data.summary.totalGrossRevenue).toLocaleString()}`}
                      subtext="Before fees"
                      icon={<DollarSign className="w-5 h-5" />}
                      color="text-blue-400"
                    />
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <MetricCard 
                    ...
                    subtext="Unique failures (excl. retries)"
                            ...
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-400">
                                  {reason.count} failures • ${reason.lostRevenue} attempted
                                </p>
                              </div>
                            </div>
                            <div className="w-full bg-gray-900 rounded-full h-2">
                ...
                {(() => {
                  ...
                  customerLastPayment.forEach((lastDate, customerId) => {
                    if (lastDate < cancellationThreshold) {
                      ...
                      // Attribute the churn to the date range after their last payment
                      const churnDate = new Date(lastDate);
                      churnDate.setDate(churnDate.getDate() + 35); // Churn happened 35 days after last payment
                      
                      if (churnDate >= thirtyDaysAgo && churnDate <= today) {
                        const dateKey = churnDate.toISOString().split('T')[0];
